        ...
        <div className="max-w-[1440px] m-auto">
            <Slider {...settings}>
                {CarouselData.map((feature: any) => (
                    <div key={feature.uuid} className="relative">
                        <Image
                            ...
                            height={0}
                            sizes="100%"
                            className="w-[1440px] h-[450px] md:h-[577px] brightness-[0.3]"
                        />
                        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[818px] text-center text-white ">
                            <h1 className="text-xl md:text-4xl lg:text-7xl px-0 md:px-10 font-semibold">
                                {feature.name}
                            </h1>
